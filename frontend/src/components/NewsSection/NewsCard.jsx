...
const NewsCard = ({ article }) => {
  ...
  return (
    <motion.article
      ...
      className="bg-slate-900 border border-slate-800 rounded-xl p-0 shadow-lg hover:shadow-xl hover:border-blue-600/50 cursor-pointer group h-full flex flex-col transition-all duration-200"
      onClick={openArticle}
    >
      {/* Image */}
